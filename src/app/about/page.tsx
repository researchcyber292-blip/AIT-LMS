            ...
            <div className="flex flex-col gap-4">
              {role === 'student' && (
                <>
                  ...
                  <Button asChild size="lg" variant="outline" className="h-14 w-full justify-center border-gray-700 bg-transparent text-lg font-medium text-white hover:bg-gray-900 hover:text-white">
