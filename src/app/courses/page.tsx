...
const allCourses: Course[] = [
    ...
    },
    {
      ...
      description: 'Dissect and analyze malicious software in a safe environment.',
      longDescription: '...',
      price: 899,
      image: 'https://images.unsplash.com/photo-1598647996231-7517d01859b3?w=800&auto=format&fit=crop',
      ...
      rating: 5, reviews: 750, lessons: 110, students: 2500,
      instructor: { name: 'Rajesh Kumar', avatar: 'https://picsum.photos/seed/instructor-1/40/40' }
    },
    {
      id: 'digital-forensics-1',
      title: 'Digital Forensics for Pentesters',
      description: 'Learn evidence collection, analysis, and reporting.',
      longDescription: '...',
      price: 750,
      image: 'https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?w=800&auto=format&fit=crop',
      imageHint: 'digital forensics data',
      instructorId: 'inst-2',
      learningObjectives: [],
      curriculum: [],
      level: 'Intermediate',
      category: 'Digital Forensics',
      priceType: 'paid', duration: '75h', liveSessionsEnabled: true, resourcesEnabled: true, createdAt: null,
      rating: 4, reviews: 880, lessons: 140, students: 3900,
      instructor: { name: 'Priya Sharma', avatar: 'https://picsum.photos/seed/instructor-2/40/40' }
    },
    {
      id: 'cyber-law-1',
      title: 'Introduction to Cybersecurity Law and Policy',
      description: 'Understand the legal framework of cybersecurity and data privacy.',
      longDescription: '...',
      price: 299,
      image: 'https://images.unsplash.com/photo-1505664194779-8beace72944f?w=800&auto=format&fit=crop',
      imageHint: 'law books gavel',
      instructorId: 'inst-3',
      learningObjectives: [],
      curriculum: [],
      level: 'Beginner',
      category: 'Cybersecurity Law',
      priceType: 'paid', duration: '25h', liveSessionsEnabled: false, resourcesEnabled: true, createdAt: null,
      rating: 4, reviews: 1100, lessons: 50, students: 7200,
      instructor: { name: 'Amit Das', avatar: 'https://picsum.photos/seed/instructor-3/40/40' }
    },
    {
    ...
    },
    {
      ...
      description: 'Learn to find security flaws in Android and iOS applications.',
      longDescription: '...',
      price: 800,
      image: 'https://images.unsplash.com/photo-1616410011239-a17fb3212453?w=800&auto=format&fit=crop',
      imageHint: 'mobile app security',
      instructorId: 'inst-1',
      learningObjectives: [],
      curriculum: [],
      level: 'Advanced',
      category: 'Penetration Testing',
      priceType: 'paid', duration: '65h', liveSessionsEnabled: true, resourcesEnabled: true, createdAt: null,
      rating: 5, reviews: 700, lessons: 100, students: 2800,
      instructor: { name: 'Rajesh Kumar', avatar: 'https://picsum.photos/seed/instructor-1/40/40' }
    },
    {
      id: 'coding-2',
    ...
    {
      id: 'digital-forensics-2',
      title: 'Advanced Memory Forensics & Threat Detection',
      description: 'Deep dive into memory analysis for incident response.',
      longDescription: '...',
      price: 1100,
      image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=800&auto=format&fit=crop',
      imageHint: 'data charts forensics',
      instructorId: 'inst-4',
      learningObjectives: [],
      curriculum: [],
      level: 'Highly Advanced',
      category: 'Digital Forensics',
      priceType: 'paid', duration: '100h', liveSessionsEnabled: false, resourcesEnabled: true, createdAt: null,
      rating: 5, reviews: 450, lessons: 90, students: 1500,
      instructor: { name: 'Anjali Menon', avatar: 'https://picsum.photos/seed/instructor-4/40/40' }
    },
    {
      id: 'malware-analysis-2',
      title: 'Ransomware Analysis and Mitigation',
      description: 'Learn how to analyze ransomware and protect against attacks.',
      longDescription: '...',
      price: 950,
      image: 'https://images.unsplash.com/photo-1614064548237-02f0f3543c43?w=800&auto=format&fit=crop',
      imageHint: 'ransomware lock screen',
      instructorId: 'inst-5',
      learningObjectives: [],
      curriculum: [],
      level: 'Advanced',
      category: 'Malware Analysis',
      priceType: 'paid', duration: '80h', liveSessionsEnabled: true, resourcesEnabled: true, createdAt: null,
      rating: 5, reviews: 650, lessons: 80, students: 2200,
      instructor: { name: 'Vijay Singh', avatar: 'https://picsum.photos/seed/instructor-5/40/40' }
    },
    {
      id: 'cyber-law-2',
      title: 'GDPR and Data Privacy Compliance',
      description: 'A comprehensive guide to understanding and implementing GDPR.',
      longDescription: '...',
      price: 350,
      image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&auto=format&fit=crop',
      imageHint: 'person signing document',
      instructorId: 'inst-1',
      learningObjectives: [],
      curriculum: [],
      level: 'Intermediate',
      category: 'Cybersecurity Law',
      priceType: 'paid', duration: '30h', liveSessionsEnabled: false, resourcesEnabled: true, createdAt: null,
      rating: 4, reviews: 800, lessons: 45, students: 6000,
      instructor: { name: 'Rajesh Kumar', avatar: 'https://picsum.photos/seed/instructor-1/40/40' }
    },
    {
