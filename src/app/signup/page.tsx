    ...
    <div className="w-full bg-background text-foreground pt-14">
      <div className="container flex min-h-[calc(100vh-3.5rem)] items-center justify-center py-12">
        <div className="w-full max-w-md">
            <h1 className="mb-8 text-center text-4xl font-headline font-bold tracking-tight text-foreground">
              Create your account
            </h1>
            ...
            <div className="flex flex-col gap-4">
              {role === 'student' && (
                <>
                  ...
                  <Button asChild size="lg" className="h-14 w-full justify-center bg-primary text-primary-foreground text-base font-bold hover:bg-primary/90">
