...
export default function InstructorLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const docRef = doc(firestore, 'instructors', user.uid);
      ...
      if (userDoc.exists()) {
        ...
        // If not an instructor, sign out and show error
        await auth.signOut();
        toast({
          variant: 'destructive',
          title: 'Access Denied',
          description: 'This email is not registered as an instructor account.',
        });
      }
    } catch (error: any) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
        ...
        <div className="w-full bg-[#0D0D0D] text-white flex items-center justify-center p-4 relative">
            ...
            <div className="w-full max-w-sm z-10">
                <h1 className="text-5xl font-light">Instructor Login</h1>
                <p className="text-gray-400 mt-2 mb-8">Access your instructor dashboard.</p>
